...
public class CustomerInfoRepository {
    ...
    public CustomerInfoRepository() {
        customers.add(createTestCustomer(generateCustomerId(), "Alex", "alex@gmx.com"));
        customers.add(createTestCustomer(generateCustomerId(), "Boc", "bob@web.com"));
    }

    public String createCustomer(Customer customer) {

        Customer c = createTestCustomer(generateCustomerId(), "Wasili, Saizew", "wsaizew@mail.ru");
